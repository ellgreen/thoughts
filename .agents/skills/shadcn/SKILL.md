...
> **IMPORTANT:** Run all CLI commands using the project's package runner: `pnpm dlx shadcn@latest` — based on the project's `packageManager`. Examples below use `npx shadcn@latest` but substitute the correct runner for the project.
