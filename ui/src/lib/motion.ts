...
/** The workhorse: quick, barely overshoots. Layout changes and reflows. */
...
/** Livelier, with a visible bounce. Reserved for moments worth noticing. */
...
/** For opacity and colour, where a spring reads as a wobble. */
export const ease: Transition = {
  duration: 0.18,
  ease: [0.32, 0.72, 0, 1],
};

/** Notes and cards arriving and leaving. */
